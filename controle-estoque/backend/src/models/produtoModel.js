// Comando de acesso a dados (MODEL) da entidade Produto.
// O JOIN traz traz também o nome da caegoria para facilitar a exibição.
...
async function atualizar(id, dados) {
    const [nome, descricao, preco, quantidade, estoque_minimo] = dados
    await pool.query(
        `UPDATE produtos SET
